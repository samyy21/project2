...
import static com.paytm.pgplus.payloadvault.theia.constant.TheiaConstant.RequestParams.TXN_DISCRIPTION;
...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.RESEND_COUNT;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.UNIQUE_ID;
...
//    }
    ...
    private void validateJWTToken(SendOTPRequestV1 request) {
        ...
        if (TokenType.JWT.equals(request.getHead().getTokenType())) {
            ...
            jwtMap.put(TheiaConstant.RequestParams.Native.MID, request.getBody().getMid());
