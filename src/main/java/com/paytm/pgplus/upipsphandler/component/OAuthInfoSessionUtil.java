...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.ExtraConstants;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.EMAIL;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.MSISDN;
...
public class OAuthInfoSessionUtil {
    ...
    public void setOAuthInfo(final PaymentRequestBean requestData, final WorkFlowResponseBean responseData) {
        ...
        if (httpServletRequest != null
            ...
            responseUrl = ConfigurationUtil.getProperty(TheiaConstant.SessionAttributes.OAUTH_RES_SERVER_URI_OLD_PG);
            LOGGER.info("oauth responsereturn  old pg url is : " + responseUrl);

        } else {
            responseUrl = ConfigurationUtil.getProperty(TheiaConstant.SessionAttributes.OAUTH_RES_SERVER_URI);
        }
