...
import com.paytm.pgplus.payloadvault.theia.response.PaymentInfo;
...
import com.paytm.pgplus.upipsphandler.enums.PaymentCollectionTypes;
import com.paytm.pgplus.upipsphandler.exception.OfflinePaymentUtils;
import com.paytm.pgplus.upipsphandler.exception.TheiaControllerException;
...
import com.paytm.pgplus.upipsphandler.service.IMerchantExtendedInfoDataService;
...
import com.paytm.pgplus.upipsphandler.utils.SplitSettlementHelper;
...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.AdditionalCallBackParam.*;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.AdditionalCallBackParam.PHONE;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.ExtendedInfoPay.PAYTM_MERCHANT_ID;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.ExtraConstants.*;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.ExtraConstants.RESULT_STATUS;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.FF4J.*;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.MerchantExtendedInfo.MerchantExtendInfoKeys.*;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.MerchantExtendedInfo.MerchantExtendInfoKeys.AGG_MID;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.MerchantExtendedInfo.MerchantExtendInfoKeys.MERCHANT_NAME;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.*;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.ADDRESS_1;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.ADDRESS_2;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.CARD_SCHEME;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.ERROR_CODE;
...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestTypes.LINK_BASED_PAYMENT;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.ResponseConstants.AGGREGATOR_MID;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.ResponseConstants.PAYMENT_RETRY_INFO;
import static com.paytm.pgplus.upipsphandler.enums.ERequestType.OFFLINE;
    ...
    public String getFinalHtmlResponse(TransactionResponse response) {
        ...
        if (merchantPreferenceService.isEncRequestEnabled(response.getMid()) || isAES256Encrypted) {
            ...
            if (dynamicWrapperUtil.isDynamicWrapperEnabled()
                    && (dynamicWrapperUtil.isDynamicWrapperConfigPresent(response.getMid(), com.paytm.pgplus.payloadvault.dynamicwrapper.enums.API.PROCESS_TRANSACTION,
                            ...
                            && (StringUtils.equals((String) extraParamsMap.get(WRAPPER_NAME), SBMOPS_WRAPPER)) && dynamicWrapperUtil
                                .isDynamicWrapperConfigPresent((String) extraParamsMap.get(AGG_MID_WRAPPER),
                                        com.paytm.pgplus.payloadvault.dynamicwrapper.enums.API.PROCESS_TRANSACTION, PayloadType.RESPONSE)))) {
                ...
                try {
                    ...
                    Map<String, Object> merchantResponseParams = wrapperService.wrapResponse(response, mid,
                            com.paytm.pgplus.payloadvault.dynamicwrapper.enums.API.PROCESS_TRANSACTION);
                    ...
                    && dynamicWrapperUtil.isDynamicWrapperConfigPresent(
                            (String) extraParamsMap.get(RESELLER_PARENT_MID), com.paytm.pgplus.payloadvault.dynamicwrapper.enums.API.PROCESS_TRANSACTION,
...
//
    public void fillTransactionResponseMap(TransactionResponse response, StringBuilder strBuilder,
        ...
        HttpServletRequest request = (javax.servlet.http.HttpServletRequest)((ServletRequestAttributes) RequestContextHolder.getRequestAttributes())
                .getRequest();
...
//        NativeJsonResponse nativeJsonResponse = new NativeJsonResponse();
//
//        ResultInfo nativeResultInfo = NativePaymentUtil.resultInfo(ResultCode.SUCCESS);
    ...
    private void putDataForLinkPaymentInAppOnlineFlow(TransactionResponse response, StringBuilder strBuilder,
        ...
        if (orderDetail != null && orderDetail.getLinkDetailsData() != null
            ...
            if (TXN_SUCCESS.equalsIgnoreCase(response.getTransactionStatus())
                    ...
                    || (ff4jUtils.isFeatureEnabled(COTP_REDIRECTION, false) && TheiaConstant.ExtraConstants.SUCCESS
...
//
    public void pushPtcResultStatusToStatsD(String resultStatus) {
        if (StringUtils.equals(OfflinePaymentUtils.gethttpServletRequest().getRequestURI(), V1_PTC)
            ...
            HttpServletRequest request = (HttpServletRequest) OfflinePaymentUtils.gethttpServletRequest();
