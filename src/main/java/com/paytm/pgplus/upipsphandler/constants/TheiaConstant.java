 ...
 *
 */
package com.paytm.pgplus.upipsphandler.constants;
...
public final class TheiaConstant {
    ...
    public static final class RequestParams {
        ...
        public static final String TOKEN_REQUESTOR_ID = "tokenRequestorId";
    ...
    public static final class ExtraConstants {
        ...
        public static final String EIGHT_DIGIT_BIN_HASH = "eightDigitBinHash";

        public static final String THEIA_ENABLE_PROMO_WALLET_CASHBACK = "theia.enablePromoWalletCashback";
    }
...
//    }
    ...
    public static final class UPIPSPKeys {
        public static final String REQUEST_TYPE = "requestType";
        public static final String TXN_AMOUNT = "txnAmount";
        public static final String PAYEE_VPA = "payerVpa";
        public static final String MID = "mid";
        public static final String ORDER_ID = "orderId";
        ...
        public static final String QR_SUBSCRIPTION = "QR_SUBSCRIPTION";
        public static final String UPI_CREDIT_CARD = "UPI_CREDIT_CARD";
    ...
    public static final class DynamicQRRetryConstant {
        public static final String THEIA_DYNAMIC_QR_RETRY_ENABLED = "theia.dynamic.qr.retry.enable";

        public DynamicQRRetryConstant() {
        }
    }
}
