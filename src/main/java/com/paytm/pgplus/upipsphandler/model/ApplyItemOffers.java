...
public class ApplyItemOffers implements Serializable {
    ...
    private com.paytm.pgplus.models.PromoCartDetails cartDetails; // This is required for item offers in
    // AND Offers flow
    ...
    public com.paytm.pgplus.models.PromoCartDetails getCartDetails() {
        return cartDetails;
    }
