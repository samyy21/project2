...
import com.paytm.pgplus.upipsphandler.utils.MerchantPreferenceUtil;
...
public class PreRedisCacheServiceImpl implements IPreRedisCacheService {
    ...
    @Override
    @Cacheable(value = TheiaConstant.CacheConstant.REDIS_KEYS_CACHE, cacheManager = "timeoutCacheManager", key = "\"M_PREFERENCE_\"+#merchantid")
