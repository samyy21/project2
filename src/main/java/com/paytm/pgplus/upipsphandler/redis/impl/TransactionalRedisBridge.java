...
@Service("transactionalRedisBridge")
public class TransactionalRedisBridge implements IRedisBridge {
    @Autowired
    TransactionalRedisBridgeWorker redisBridgeWorker;

    public TransactionalRedisBridge() {
    }
    ...
    public Long ttl(String key) {
        throw new UnsupportedOperationException("Not supported in transactionalRedisBridge");
    }
