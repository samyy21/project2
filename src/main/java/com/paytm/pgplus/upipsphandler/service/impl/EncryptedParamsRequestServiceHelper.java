...
import com.paytm.pgplus.upipsphandler.model.EncryptedParameterRequest;
import com.paytm.pgplus.upipsphandler.model.HttpRequestWithModifiableParameters;
...
//    }
    ...
    public Map<String, Object> buildCustomAttributeMap(HttpServletRequest decryptRequest) {
        ...
        overrideAttributeMap.put(TheiaConstant.RequestParams.ORDER_ID, decryptRequest.getParameter(TheiaConstant.RequestParams.ORDER_ID));
        overrideAttributeMap.put(TheiaConstant.RequestParams.MID, decryptRequest.getParameter(TheiaConstant.RequestParams.MID));
