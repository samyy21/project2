...
import com.paytm.pgplus.upipsphandler.preredis.impl.MerchantDataServiceImpl;
...
public class MerchantDataUtil {
    ...
    private IMerchantDataService merchantDataServiceImpl = new MerchantDataServiceImpl();
