...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.GvConsent.PTR_URL;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.Native.*;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.SOURCE;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestTypes.OFFLINE;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.ResponseConstants.ResponseCodes.SUBSCRIPTION_PENDING_RESPONSE_CODE;
...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.ResponseConstants.SUBSCRIPTION_PENDING_MESSAGE;
...
//    }
    ...
    private TransactionResponse createResponseForSession(QueryByMerchantTransIdResponseBody response,
        ...
        if (response.getExtendInfo() != null) {
            ...
            // for native
            if (response.getExtendInfo().containsKey(TheiaConstant.RequestParams.Native.MERC_UNQ_REF)) {
                transactionResponse.setMerchUniqueReference(response.getExtendInfo().get(TheiaConstant.RequestParams.Native.MERC_UNQ_REF));
...
//            String workflow = nativeSessionUtil.getTxnTokenAndWorkflowOnMidOrderId(midOrderIdKey, TheiaConstant.RequestParams.Native.WORKFLOW);
//            if (StringUtils.isNotBlank(workflow) && TheiaConstant.RequestParams.Native.CHECKOUT.equals(workflow)) {
