...
import com.paytm.pgplus.upipsphandler.model.BalanceInfoResponse;
import com.paytm.pgplus.upipsphandler.model.BalanceInfoServiceRequest;
import com.paytm.pgplus.upipsphandler.model.FetchBalanceInfoRequest;
import com.paytm.pgplus.upipsphandler.service.AbstractRequestProcessor;
...
//
    private InitiateTransactionRequestBody validate(FetchBalanceInfoRequest request) {
        ...
        if (StringUtils.isBlank(paytmSsoToken)) {
            throw PaymentRequestProcessingException.getException(String.valueOf(ResultCode.OPERATAION_NOT_SUPPORTED));
        }
        return orderDetail;
    }
//
