...
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.SAVED_CARD_ENABLE;
import static com.paytm.pgplus.upipsphandler.constants.TheiaConstant.RequestParams.SAVED_CARD_ENABLE_ALT;
...
public class TheiaCashierMapper {
    ...
    public PaymentRequest preparePaymentRequest(final TheiaPaymentRequest theiaPaymentRequest,
        ...
        PaymentRequest.PaymentRequestBuilder builder = new PaymentRequest.PaymentRequestBuilder(paymentType, transId, transType,
    ...
    private PayBillOptions preparePayBillOptions(final TheiaPaymentRequest theiaPaymentRequest,
        ...
        PayBillOptions.PayBillOptionsBuilder builder = new PayBillOptions.PayBillOptionsBuilder(serviceAmount, chargeFeeAmount, payOptions)
    ...
    private CashierEnvInfo prepareCashierEnvInfo(final TheiaPaymentRequest input, final PaymentInfo paymentInfo,
        ...
        EnvInfo.EnvInfoBuilder envInfoBuilder;
        try {
            envInfoBuilder = new EnvInfo.EnvInfoBuilder(envInfoRequestBean.getClientIp(), terminalType.getTerminal());
        ...
        final CashierEnvInfo.CashierEnvInfoBuilder builder = new CashierEnvInfo.CashierEnvInfoBuilder(envInfoRequestBean.getClientIp(), terminalType)
