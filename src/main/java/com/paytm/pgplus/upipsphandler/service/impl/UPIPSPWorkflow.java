...
import com.paytm.pgplus.upipsphandler.component.LinkPaymentConsultUtil;
...
import com.paytm.pgplus.upipsphandler.service.IWorkFlow;
...
public class UPIPSPWorkflow implements IWorkFlow {
    ...
    private String getTxnAmountforResponse(WorkFlowRequestBean flowRequestBean, boolean orderExistOnAlipay) {
