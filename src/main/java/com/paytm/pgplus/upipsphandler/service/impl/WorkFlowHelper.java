...
import com.paytm.pgplus.biz.workflow.service.helper.*;
...
import com.paytm.pgplus.facade.bankOauth.models.Wallet2FAWorkflowIdRequest;
import com.paytm.pgplus.facade.bankOauth.models.Wallet2FAWorkflowIdResponse;
...
import com.paytm.pgplus.facade.wallet.models.WalletBalanceResponseData;
...
import com.paytm.pgplus.upipsphandler.service.ILogin;
...
import static com.paytm.pgplus.payloadvault.theia.constant.TheiaConstant.FF4J.THEIA_ENABLE_CARD_HASH_GENERATION;
...
public class WorkFlowHelper {
    ...
    private boolean bypassVelocity(String mid) {
        return AllowedMidCustidPropertyUtil.isMidCustIdEligible(mid, null,
                MerchantVelocity.BYPASS_VELOCITY_MIDS, MerchantVelocity.NONE, false);
    }
    ...
    public Map<String, String> getExtendInfoFromExtendBean(WorkFlowRequestBean flowRequestBean) {
        ...
        extendInfo.put(ExtendedInfoKeys.TOTAL_TXN_AMOUNT, extendInfoBean.getTotalTxnAmount());
        extendInfo.put(ExtendedInfoKeys.ISSUING_BANK_NAME, flowRequestBean.getBankName());
        // extendInfo.put(BizConstant.ExtendedInfoKeys.RETRY_COUNT, "0");
        extendInfo.put(ExtendedInfoKeys.MERCHANT_NAME, extendInfoBean.getMerchantName());
        extendInfo.put(ExtendedInfoKeys.MCC_CODE, extendInfoBean.getMccCode());
        extendInfo.put(ExtendedInfoKeys.PRODUCT_CODE, extendInfoBean.getProductCode());
        extendInfo.put(ExtendedInfoKeys.EMI_PLAN_ID, extendInfoBean.getEmiPlanId());
        extendInfo.put(ExtendedInfoKeys.TOPUP_AND_PAY, "false");
        extendInfo.put(ExtendedInfoKeys.MERCHANT_TRANS_ID, extendInfoBean.getMerchantTransId());
        extendInfo.put(ExtendedInfoKeys.PAYTM_MERCHANT_ID, extendInfoBean.getPaytmMerchantId());
        extendInfo.put(ExtendedInfoKeys.ISSUING_BANK_ID, flowRequestBean.getInstId());
        extendInfo.put(ExtendedInfoKeys.ALIPAY_MERCHANT_ID, extendInfoBean.getAlipayMerchantId());
        extendInfo.put(ExtendedInfoKeys.TXNTYPE, "ONLY_PG");
        extendInfo.put(ExtendedInfoKeys.IS_ENHANCED_NATIVE,
    ...
    private void pushRequestToDwhKafkaTopic(Object payRequest, String mid) {
        boolean ff4jNotifyPaymentRequestData = ff4JUtil.isFeatureEnabled(
                Ff4jFeature.NOTIFY_PAYMENT_REQUEST_DATA, mid);
    ...
    private void pushPayloadToDwhKafkaTopic(Object payRequest, String mid) {
        try {
            ...
            boolean logStackTrace = ff4JUtil.isFeatureEnabled(Ff4jFeature.NOTIFY_PAYMENT_DWH_STACKTRACE,
                    mid);
            if (logStackTrace)
    ...
    private GenericCoreResponseBean<?> getForFeeOnAddNPayTransaction(WorkFlowTransactionBean workFlowTransBean) {
        ...
        if (!response.isSuccessfullyProcessed()) {
            ...
            GenericCoreResponseBean<com.paytm.pgplus.biz.workflow.model.WorkFlowTransactionBean> workFlowTransactionBeanGenericCoreResponseBean = walletConsultService
